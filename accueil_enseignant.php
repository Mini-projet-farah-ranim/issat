    ...
    <main>
      <nav class="main-menu">
        ...
        <ul>
          ...
          <li class="nav-item">
    <a href="#" id="suiviEtudiantsDropdown" class="nav-link">
...
<script>
    document.getElementById('suiviEtudiantsDropdown').addEventListener('click', function() {
        ...
        if (dropdownMenu.style.display === 'none') {
          ...
          <li class="nav-item">
            ...
            <a href="#">
              <i class="fa fa-calendar aria-hidden='true' nav-icon"></i>
              <span class="nav-text">Calendrier universitaire</span>
            </a>
          </li>
        </ul>
      </nav>
        ...
        <div class="right-content">
          ...
          <div class="liens">
            ...
            <div class="liens-container">
              ...
              <p><i class="fa fa-external-link" aria-hidden="true"></i><span><a href="http://www.mes.tn/">Ministere de l'enseignement superieur</a></span></p>
